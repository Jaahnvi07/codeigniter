            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Slot</a></li>
					</ol>
                </div>
                <!-- row --> 
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h4 class="card-title">Slot Detail</h4>
                                <button name="btnadd" type="button" onclick="window.location='<?php echo base_url(); ?>slot/add';" class="btn btn-rounded btn-primary"><span
                                    ...
                                    <table id="example3" class="display table-responsive-lg">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($row->slot_status=="free") { ?> 
                                                    <a href="javascirpt:void(0);" class="btn btn-sm btn-success">FREE</a>
                                                    <?php } else { ?>
                                                         <a href="javascirpt:void(0);" class="btn btn-sm btn-danger">ALLOCATE</a>
                                                        <?php } ?>
                                                    </td>
                                                <td>
                                                    <a data-id="<?php echo $row->sid; ?>" data-toggle="modal" data-target="#basicModal" class="btn  open-dialog">Delete</a>
                                               | <a href="<?php echo base_url(); ?>slot/update/<?php echo $row->sid; ?>" class="btn">Edit</a></td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
                                    </table>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="<?php echo base_url(); ?>slot/delete">
