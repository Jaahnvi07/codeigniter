            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">place</a></li>
					</ol>
                </div>
                <!-- row --> 
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h4 class="card-title">place Detail</h4>
                                <button name="btnadd" type="button" onclick="window.location='<?php echo base_url(); ?>place/add';" class="btn btn-rounded btn-primary"><span
                                    ...
                                    <table id="example3" class="display table-responsive-lg">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a data-id="<?php echo $row->pid; ?>" data-toggle="modal" data-target="#basicModal" class="btn  open-dialog">Delete</a>
                                                | <a href="<?php echo base_url(); ?>place/update/<?php echo $row->pid; ?>" class="btn">Edit</a></td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
                                    </table>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="<?php echo base_url(); ?>place/delete">
