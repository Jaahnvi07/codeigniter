                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <form method="post" action="<?php echo base_url(); ?>place/insert" id="form1" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            Address:<textarea class="form-control"  rows="4" id="comment" name="txtaddress"></textarea>
                                        </div>
                                         <div class="form-group">
                                            Landmark:<textarea class="form-control"  rows="4" id="comment" name="txtlandmark"></textarea>
                                        </div>
                                        <div class="form-group">
                                        Pincode :
                                           <input type="text" id="txtpincode" name="txtpincode" class="form-control input-rounded" onBlur='checkcatname()'>
                                           <span class="error" id="lblcname"></span>
                                        </div>
