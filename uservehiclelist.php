                            ...
                            <div class="app-note-container">
                                ...
                                <div id="ct" class="note-container note-grid">
                                    ...
                                    <div class="note-item all-notes note-personal">
                                        <div class="note-inner-content">
                                            <div class="note-content">
                                                <p class="note-title" data-noteTitle="Meeting with Kelly"><?php echo $row->vname; ?></p>
                                                
                                            </div>
                                            
                                            <div class="note-action">
                                               <a href="<?php echo base_url(); ?>userspotlist/<?php echo $placeid; ?>/<?php echo $row->vid; ?>" class="btn btn-primary">View Spot</a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php } ?>
