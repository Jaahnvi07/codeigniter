                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <form method="post" action="<?php echo base_url(); ?>slot/insert" id="form1" enctype="multipart/form-data">
                                        <div class="form-group">
                                        Place name :
                                           <select id="txtpname" name="txtpname" class="form-control input-rounded">
                                        ...
                                        <div class="form-group">
                                            Vehicle Name:<select id="txtvname" name="txtvname" class="form-control input-rounded">
                                        ...
                                        <?php } ?>
                                         ...
                                         <div class="form-group">
                                            Slot Name:<input type="text" id="txtsname" name="txtsname" class="form-control input-rounded" onBlur='checkcatname()'>
                                           <span class="error" id="lblcname"></span>
                                        </div>
                                         <div class="form-group">
                                            Price:<input type="text" id="txtprice" name="txtprice" class="form-control input-rounded" onBlur='checkcatname()'>
                                           <span class="error" id="lblcname"></span>
                                        </div>
