                                    ...
                                    <table id="example3" class="display table-responsive-lg">
                                       ...
                                       <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url(); ?>viewbookingdetail/<?php echo $row->bid; ?>"><?php echo $row->name; ?></a></td>
                                                <td><?php echo $row->vnumber; ?></td>
                                                <td><?php echo $row->sname; ?></td>
                                                <td><?php echo $row->time; ?></td>
                                                  <td>
                                                      <a href="<?php echo base_url(); ?>booking/changestatus/pending/<?php echo $row->bid; ?>" class="btn btn-sm btn-<?php if($row->status=="pending") echo 'danger'; else echo 'primary';?>">Pending</a>
                                                      <a href="<?php echo base_url(); ?>booking/changestatus/allocate/<?php echo $row->bid; ?>" class="btn btn-sm btn-<?php if($row->status=="allocate") echo 'danger'; else echo 'primary';?>">Allocate</a>
                                                      <a href="<?php echo base_url(); ?>booking/changestatus/release/<?php echo $row->bid; ?>" class="btn btn-sm btn-<?php if($row->status=="release") echo 'danger'; else echo 'primary';?>">Release</a>
                                                  </td>
                                                ...
                                                <td>
                                                     <a  data-id="<?php echo $row->bid; ?>" data-toggle="modal" data-target="#basicModal" class="btn  open-dialog">Delete</a>
                                                 </td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="<?php echo base_url(); ?>booking/delete">
