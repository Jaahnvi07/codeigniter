                                    ...
                                    <div class="note-item all-notes note-personal">
                                        <div class="note-inner-content">
                                            <div class="note-content">
                                                <p class="note-title" data-noteTitle="Meeting with Kelly"><?php echo $row->pname; ?></p>
                                                <div class="note-description-content">
                                                    <p class="note-description" data-noteDescription="Curabitur facilisis vel elit sed dapibus sodales purus rhoncus."><?php echo $row->address; ?>,<?php echo $row->landmark; ?>,<?php echo $row->pincode; ?></p>
                                                </div>
                                            </div>
                                            <div class="note-action">
                                               <a href="<?php echo base_url(); ?>uservehiclelist/<?php echo $row->pid; ?>" class="btn btn-primary">View Vehicle List</a>
                                            </div>
