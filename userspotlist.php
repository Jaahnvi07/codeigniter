                            ...
                            <div class="app-note-container">
                                ...
                                <div id="ct" class="note-container note-grid">
                                    ...
                                    <div class="note-item all-notes note-personal">
                                        <div class="note-inner-content">
                                            <div class="note-content">
                                                <p class="note-title" data-noteTitle="Meeting with Kelly"><?php echo $row->sname; ?></p>
                                                <p class="meta-time">Slot Status:<?php echo $row->slot_status; ?></p>
                                                <div class="note-description-content">
                                                 <p class="meta-time">vehicle type:<?php echo $row->vname; ?></p>
                                                 </div>
                                                <div class="note-description-content">
                                                    <p class="note-description" data-noteDescription="Curabitur facilisis vel elit sed dapibus sodales purus rhoncus.">Price:<?php echo $row->price; ?></p>
                                                </div>
                                            </div>
                                            
                                            <div class="note-action">
                                               <a href="<?php echo base_url(); ?>bookingform/<?php echo $row->sid; ?>" class="btn btn-primary">Booking Form</a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php } ?>
